...
func compute(A ULONG64, B ULONG64) ULONG64 {
    ...
    s = int32(S1[int32((d.l >> 24 | d.r << 8) & 0x1FFF)])
    e.l = P[s].l >> 7
    e.r = P[s].r >> 7

    s = int32(S1[int32((d.l >> 16) & 0x7FF)])
    e.l |= P[s].l >> 6
    e.r |= P[s].r >> 6

    s = int32(S1[int32((d.l >> 8) & 0x1FFF)])
    e.l |= P[s].l >> 5
    e.r |= P[s].r >> 5

    s = int32(S1[int32(d.l & 0x7FF)])
    e.l |= P[s].l >> 4
    e.r |= P[s].r >> 4

    s = int32(S1[int32((d.r >> 24 | d.l << 8) & 0x7FF)])
    e.l |= P[s].l >> 3
    e.r |= P[s].r >> 3

    s = int32(S1[int32((d.r >> 16) & 0x1FFF)])
    e.l |= P[s].l >> 2
    e.r |= P[s].r >> 2

    s = int32(S1[int32((d.r >> 8) & 0x7FF)])
    e.l |= P[s].l >> 1
    e.r |= P[s].r >> 1

    s = int32(S1[int32(d.r & 0x1FFF)])
    e.l |= P[s].l
    e.r |= P[s].r
    ...
    f.l = uint64(
          (S2[int32(((e.l >> 24) & 0xFF) | ((B.l >> 21) &  0x700))]) << 24 |
          (S2[int32(((e.l >> 16) & 0xFF) | ((B.l >> 18) &  0x700))]) << 16 |
          (S1[int32(((e.l >>  8) & 0xFF) | ((B.l >> 13) & 0x1F00))]) <<  8 |
          (S1[int32(((e.l      ) & 0xFF) | ((B.l >>  8) & 0x1F00))]))

    f.r = uint64(
          (S2[int32(((e.r >> 24) & 0xFF) | ((B.l >> 5) &  0x700))]) << 24 |
          (S2[int32(((e.r >> 16) & 0xFF) | ((B.l >> 2) &  0x700))]) << 16 |
          (S1[int32(((e.r >>  8) & 0xFF) | ((B.l << 3) & 0x1F00))]) <<  8 |
          (S1[int32(( e.r        & 0xFF) | ((B.r << 8) & 0x1F00))]))
