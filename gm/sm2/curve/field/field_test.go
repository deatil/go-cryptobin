...
func Test_Bytes(t *testing.T) {
    ...
    d.l = ([9]uint32{0x10, 0x0, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x0, 0x01})
...
func Test_Mul(t *testing.T) {
    ...
    a.l = ([9]uint32{0x11, 0x0, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x12, 0x01})
    b.l = ([9]uint32{0x10, 0x0, 0x1FFFF801, 0x3FFF, 0x0, 0x25, 0x0, 0x0, 0x01})
...
func Test_Equal(t *testing.T) {
    ...
    a.l = ([9]uint32{0x11, 0x0, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x12, 0x01})
    b.l = ([9]uint32{0x11, 0x0, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x12, 0x01})
...
func Test_Equal2(t *testing.T) {
    ...
    a.l = ([9]uint32{0x11, 0x0, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x12, 0x01})
    b.l = ([9]uint32{0x11, 0x1, 0x1FFFF800, 0x3FFF, 0x0, 0x0, 0x0, 0x12, 0x01})
...
func Test_IsZero2(t *testing.T) {
    ...
    a.l = ([9]uint32{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0})
    ...
    // t.Errorf("111: %x \n", P.Bytes())
    // t.Errorf("222: %x", uint64(0x1000003d1))
}
